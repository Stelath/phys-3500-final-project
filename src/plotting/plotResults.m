...
plot(impact_time, 0, 'rx', 'MarkerSize', 10, 'LineWidth', 2); % Impact
...
yline(0, 'k--');
plot(impact_time, impact_vel, 'rx', 'MarkerSize', 10, 'LineWidth', 2); % Impact
...
xline(impact_time, 'r:', 'LineWidth', 1.5); % Impact line
...
plot(ax2, impact_time, 0, 'rx', 'MarkerSize', 10, 'LineWidth', 2); % Impact
...
yline(ax3, 0, 'k--');
plot(ax3, impact_time, impact_vel, 'rx', 'MarkerSize', 10, 'LineWidth', 2); % Impact
...
xline(ax4, impact_time, 'r:', 'LineWidth', 1.5); % Impact line
...
plot(ax5, time, accel_error, 'r:', 'LineWidth', 1.5); % Red dotted line
