...
[apogee_time, apogee_height, max_vel_time, max_vel_val, max_acc_time, max_acc_val] = ...
...
[k_est, t_model, y_model] = solveDragODE(time, alt_analysis, velocity, mass, g, max_vel_time);
...
plotResults(time, alt_analysis, velocity, acceleration, t_model, y_model, apogee_idx, accel_interp);
